...
public final class ImagePipeline {
    ...
    public func load(_ url: URL, into imageView: ImageViewCompatible, transition: Transition = .none, defaultImage: UIImage? = nil, failureImage: UIImage? = nil, processors: [ImageProcessing] = []) {
...
private class ImageViewReference: Hashable {
    var imageView: ImageViewCompatible?
    private let objectIdentifier: ObjectIdentifier

    init(_ imageView: ImageViewCompatible) {
...
private class ImageViewController {
    ...
    func showImage(_ image: UIImage, transition: Transition) {
        ...
        case .fadeIn(let duration):
            if let imageView = reference?.imageView, let view = imageView as? UIView {
...
public protocol ImageViewCompatible: class {
    var image: UIImage? { get set }
}

extension UIImageView: ImageViewCompatible {}
extension UIButton: ImageViewCompatible {
